...
You can place any .png image by the name "org.png" in the folder "_test" and start ste script comparison.py. The code will create the comparing plot and save the output images in the subfolder "pred".
